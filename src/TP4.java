...
public class TP4 {
	...
	/*
	 * public static int[] newfusion(int[] array1, int[] array2) { int[] bigArray =
	 * new int[array1.length + array2.length]; int i1 = 0, i2 = 0, i = 0; while (i1
	 * < array1.length && i2 < array2.length){ if (i1 >= array1.length){
	 * bigArray[i++] = array2[i2++]; } else if (i2 >= array2.length){ bigArray[i++]
	 * = array2[i2++]; } else { if (){
	 * 
	 * } else {
	 * 
